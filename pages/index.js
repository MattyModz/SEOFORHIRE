...
export default function Home({ jobs }) {
  return (
    <>
          ...
          <div class="relative h-auto  pb-16 mx-auto max-w-6xl flex flex-col items-center">
            ...
            <div class="grid lg:max-w-3xl w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-12 lg:gap-y-5 gap-x-12 sm:gap-x-5 lg:grid-cols-7 lg:ml-10 text-gray-400">
              <div class="relative w-auto text-center flex justify-center">
                <svg
                  class="h-10 w-auto fill-red-400"
                  viewBox="0 0 344 409"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
      ...
      <section
        class="w-full py-12 bg-white sm:py-20"
      ...
      >
        <div class="flex flex-col items-center justify-center mx-auto xl:flex-row max-w-7xl">
          <div class="relative flex flex-col items-start justify-center w-full h-full max-w-2xl px-6 mx-auto xl:max-w-none xl:w-2/5">
            <h2 class="text-3xl font-normal leading-none text-gray-900 sm:w-4/5 sm:text-6xl text-3">
            ...
            <div class="relative flex mt-6 space-x-2">
              <div class="flex items-center justify-center w-10 h-10 text-white bg-indigo-600 rounded cursor-pointer hover:bg-indigo-600">
                <svg
                  class="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
          ...
          <div class="box-content relative flex items-center w-full h-auto max-w-2xl py-5 mx-auto overflow-hidden xl:w-3/5 rounded-xl bg-gradient-to-r from-transparent via-transparent to-gray-100">
            <div class="flex px-6 space-x-6 transition duration-500 ease-out transform xl:pl-6 h-94">
                  ...
                  <div class="flex-1">
                    ...
                    <a href="#_" class="block">
                      ...
                      <span class="block mt-3 text-xs leading-6 text-gray-500 sm:text-sm">
                        ...
                        perfect landing page you've got to follow these
                        proven...
                      </span>
                    </a>
                  </div>
                  <div class="items-center hidden mt-6 sm:flex">
                    <div class="relative">
                      <p class="text-xs font-medium leading-5 text-gray-500">
                        ...
                        <time class="ml-1">January 21, 2022</time>
                      </p>
                    </div>
                  </div>
                </div>
