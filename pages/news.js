            ...
            <div class="relative">
              ...
              <div class="relative mt-5">
                ...
                <a href="#" class="block mb-3 hover:underline">
                  <h2 class="text-2xl font-bold leading-5 text-black transition-colors duration-200 hover:text-deep-purple-accent-700">
                    Seeking Adventure
                  </h2>
                </a>
                ...
                <a href="#_" class="font-medium underline">
                  Read More
                </a>
              </div>
            </div>
            ...
            <div class="relative">
              <a href="#_" class="block overflow-hidden group rounded-xl">
                <img
                  ...
                  class="object-cover w-full h-64 transition-all duration-300 ease-out group-hover:scale-110"
                  alt=""
                />
              </a>
              <div class="relative mt-5">
