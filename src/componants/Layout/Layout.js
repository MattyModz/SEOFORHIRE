...
export default function Layout({ children, Herotitle }) {
  return (
    <section class="w-full p-2">
      <div class=" w-full   flex flex-col items-center px-8 pt-12 pb-24 mx-auto sm:rounded-lg bg-gradient-to-br from-indigo-600 to-purple-600 sm:pt-20 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64 sm:px-0">
