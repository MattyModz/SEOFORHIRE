      ...
      <section className="">
        ...
        <div className="w-full bg-royal">
          <div className="relative h-auto  pb-16 mx-auto max-w-6xl flex flex-col items-center">
            <div className="flex items-center text-gray-400 transform lg:-mt-4 mb-4 font-medium uppercase py-5 font-medium text-xs sm:px-0 px-5 text-center sm:text-sm rounded-xl leading-tight"></div>
            <div className="grid lg:max-w-3xl w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-12 lg:gap-y-5 gap-x-12 sm:gap-x-5 lg:grid-cols-7 lg:ml-10 text-gray-400">
              <div className="relative w-auto text-center flex justify-center"></div>
            </div>
          </div>
        </div>
      </section>
